    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Details(ShoppingCart CartObject)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //claims to retreit logged-in user's id
                var claimsIdentity = (ClaimsIdentity)User.Identity;
                var claim = claimsIdentity.FindFirst(ClaimTypes.NameIdentifier);
                ...
                else
                {
                   ...
                   // _unitOfWork.ShoppingCart.Update(cartFromDb); == asp.net.core updates without this in .save(); if it's retreived from db
                }
                _unitOfWork.Save();
                ...
                //asp.net.core has only build-in sessions for type INT
                //this is a generic way to use any type of objects.
